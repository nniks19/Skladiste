            ...
            function h() {
                ...
                return a.all([a.when(g.dtOptions), a.when(g.dtColumns), a.when(g.dtColumnDefs)]).then(function(c) {
                    ...
                    if (d.isDefined(e) && (i = {}, d.extend(i, e), d.isArray(g) && (i.aoColumns = g), d.isArray(h) && (i.aoColumnDefs = h), i.language && i.language.url)) {
                        var j = a.defer();
                        b.get('https://cdn.datatables.net/plug-ins/1.10.24/i18n/Croatian.json').success(function(a) {
                            j.resolve(a)
    ...
    function f() {
        var a = {
            ...
            withLanguage: function(a) {
                return this.language = 'https://cdn.datatables.net/plug-ins/1.10.24/i18n/Croatian.json', this
            },
            withLanguageSource: function(a) {
                return this.withLanguage({
                    url: 'https://cdn.datatables.net/plug-ins/1.10.24/i18n/Croatian.json'
                })
            },
    ...
    function l() {
        function a(a) {
            return c.extend(c.fn.dataTable.defaults, {
                oLanguage: {
                    sUrl: 'https://cdn.datatables.net/plug-ins/1.10.24/i18n/Croatian.json'
                }
            }), f
        }
        ...
        function b(a) {
            return c.extend(!0, c.fn.dataTable.defaults, {
                oLanguage: 'https://cdn.datatables.net/plug-ins/1.10.24/i18n/Croatian.json'
            }), f
        }
