...
<body class="p-3 mb-2 bg-secondary" ng-app="skladiste-panel" ng-controller="primkeCRUD">
    <headerpanelnav></headerpanelnav>
    <div class="crudbuttons">
        <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
            <div>
                <button type="button" name="add_button" ng-click="addData()" class="btn-info">Dodaj Primku</button>
            </div>
        </div>
    </div>

    <div class="crudcontainer" ng-init="dohvatiPrimke()">
        <div class="table-responsive" style="overflow-x: unset;">
            <table datatable="ng" dt-options="vm.dtOptions" class="table table-dark table-striped">
                ...
                <tbody>
                    <tr ng-repeat="Primka in Primke">
                        <td>{{Primka.sSifraDokumenta}}</td>
                        <td>{{Primka.sTipDokumenta}}</td>
                        <td>{{Primka.dDatumDokumenta}}</td>
                        <td>{{Primka.nKolicina}}</td>
            ...
            <form method="post" ng-submit="submitForm()">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <label>Tip dokumenta će biti primka, odnosno "PRM"</label>
                        <hr>
                        ...
                        <div ng-repeat="OdabraniArtikl in OdabraniArtikli">
                            ...
                            <p>Količina artikla: <input id="{{OdabraniArtikl.SifraArtikla}}" type="number" min="1"
                                    name="Artikl_Kolicina" ng-model="Artikl_Kolicina" ng-change="setKolicina(this)" class="form-control" /> <button
