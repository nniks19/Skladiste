...
<body class="p-3 mb-2 bg-secondary" ng-app="skladiste-panel" ng-controller="tabliceCRUD">
    ...
    <div class="crudcontainer" id="divtablica">
        <div>
            ...
            <button type='button' class='btn btn-primary' name="add_button" ng-click="addData()">Dodaj Artikl</button>
        </div>
        <div>
            <table class='table table-dark table-striped' datatable="ng">
                <thead>
            ...
            <table class='table table-dark table-striped' datatable="ng">
                ...
                <tbody>
                    <tr ng-repeat="oData in Kategorije">
                        ...
                        <td id="{{oData.nIdKategorije}}" ng-click="deleteData(name.id)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                                <path
                                    d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z" />
                                <path fill-rule="evenodd"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary">Spremi
                        promjene</button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="modalAddKategorija" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Zatvori</button>
                    <button type="button" class="btn btn-primary" >Dodaj
                        kategoriju</button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="modalAddArtikl" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Zatvori</button>
                    <button type="button" class="btn btn-primary">Dodaj artikl</button>
                </div>
            </div>
        </div>
    </div>
