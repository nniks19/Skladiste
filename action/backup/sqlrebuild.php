...
CREATE TABLE Korisnici (
    ...
    CONSTRAINT PK_Korisnici PRIMARY KEY (id, korisnicko_ime, email)
);
...
INSERT INTO Korisnici (korisnicko_ime, lozinka, email, ime, prezime, drzava, grad, broj_mobitela, datum_kreiranja) VALUES ('lukamajcenic', '$hashed_password' , 'luka.majcenic@vuv.hr', 'Luka', 'Majcenić', 'Hrvatska', 'Milanovac', '+385985326424', current_timestamp);
...
try{
    ...
    echo "Baza je uspješno rekreirana";
} catch (Exception $e){
    if ($e->getcode() == "42S01"){
        $sqlCommand2 = "
